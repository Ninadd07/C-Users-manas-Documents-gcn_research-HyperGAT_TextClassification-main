...
class HyperGraphAttentionLayerSparse(nn.Module):
    ...
    def forward(self, x, adj):
        ...
        if torch.isnan(pair_e).any():
            print("pair_e contains NaN values:", pair_e)
        assert not torch.isnan(pair_e).any(), "pair_e contains NaN values"
